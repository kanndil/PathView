...
<p align="justify">
Welcome to the open-source project PathView! PathView is a powerful tool that supports multiple Static Timing Analysis (STA) tools, including <a href="https://github.com/The-OpenROAD-Project/OpenSTA" target="_blank">OpenSTA</a> and <a href="https://www.synopsys.com/implementation-and-signoff/signoff/primetime.html" target="_blank">PrimeTime</a>. It aims to facilitate the visualization and analysis of timing paths extracted from STA reports.
</p>
...
<p align="justify">
By default, PathView supports both of the <a href="https://github.com/google/skywater-pdk-libs-sky130_fd_sc_hd" target="_blank">Sky130_fd_sc_hd</a> and <a href="https://github.com/google/globalfoundries-pdk-libs-gf180mcu_fd_sc_mcu7t5v0"target="_blank">gf180mcu_fd_sc_mcu7t5v0__tt_025C_5v00_</a> standard cell libraries. However, we understand that different projects may employ various standard cell libraries. Therefore, PathView also allows you to easily add support for the standard cell library you are using. Detailed instructions can be found in the "Support the standard cell library you are using" section of our project documentation, available <a href="https://github.com/kanndil/PathView#second-support-the-standard-cell-library-you-are-using"target="_blank">here</a>.
</p>
<p align="justify">
